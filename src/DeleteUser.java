...
public class DeleteUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 70, 230, 38));

        l1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        l1.setForeground(new java.awt.Color(255, 0, 0));
        l1.setText("Username");
        getContentPane().add(l1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 160, 117, -1));

        l2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        l2.setForeground(new java.awt.Color(255, 0, 0));
        l2.setText("Address");
        getContentPane().add(l2, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 220, -1, -1));

        l3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        l3.setForeground(new java.awt.Color(255, 0, 0));
        l3.setText("City");
        getContentPane().add(l3, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 300, 50, -1));

        l4.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        l4.setForeground(new java.awt.Color(255, 0, 0));
        l4.setText("MobileNo");
        getContentPane().add(l4, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 360, -1, -1));

        l5.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        l5.setForeground(new java.awt.Color(255, 0, 0));
        l5.setText("EmailID");
        getContentPane().add(l5, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 420, -1, 34));
        ...
        getContentPane().add(b1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 540, 158, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 0, 0));
        jLabel2.setText("ZIP");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 310, 37, -1));
        ...
        getContentPane().add(c1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 490, 173, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 0, 0));
        jLabel5.setText("XXXXXX");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 160, 150, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 0, 0));
        jLabel6.setText("XXXXXX");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 220, 500, 50));
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 360, 180, 30));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 0, 0));
        jLabel9.setText("XXXXXXX");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 420, 390, 30));

        jLabel11.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 0, 0));
        jLabel11.setText("XXXXXX");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 310, 110, 30));
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        try 
        {
            ...
            if(c1.isSelected())
            {
                String q1 = "DELETE FROM registration WHERE Username = '"+jLabel5.getText()+"'";
